 ...
 */
public final class MedicalAppPropertiesUtil {

    private static final Logger log = LoggerFactory.getLogger(MedicalAppPropertiesUtil.class);
    private static final String CONFIG_FILE = "config.properties";
    private static final Properties PROPERTIES = load();

    private MedicalAppPropertiesUtil() {
    }
