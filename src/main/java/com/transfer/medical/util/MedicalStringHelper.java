 ...
 */
@Slf4j
public class MedicalStringHelper {
    ...
    public static String getWorkflowCode(String fileName, String prefix, int index) {
        ...
        if (MedicalStringHelper.doEmpty(prefix).length() > 0) {
    ...
    public static long getFileNum(String fileName) {
        String date = MedicalStringHelper.getWorkflowCode(fileName, "", 4);
        date = date.substring(4);
        String pc = MedicalStringHelper.getWorkflowCode(fileName, "", 6);
        String seq = MedicalStringHelper.getWorkflowCode(fileName, "", 7);
