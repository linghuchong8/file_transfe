...
import com.transfer.medical.pojo.MedicalDownloadFileRequest;
...
/**
 * 基于医疗数据交换（EDB）客户端接口的下载与下发服务。
 *
 * @author yuanjihong
 */
@Service
@Slf4j
public class MedicalRestActionService {
    ...
    public void download(MedicalDataShareMessage msg) {
        ...
        MedicalDownloadFileRequest request = new MedicalDownloadFileRequest();
    ...
    private String buildUploadJson(MedicalSendFileInformation file, String fileName, String interfaceName,
