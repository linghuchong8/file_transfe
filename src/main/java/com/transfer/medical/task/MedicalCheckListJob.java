...
@Component
@Slf4j
public class MedicalCheckListJob implements MedicalJob {
    ...
    /**
     * 重启 Medical 服务的辅助方法（预留）。
     */
    public static void restartMedicalService() {
        log.info("准备执行重启 Medical 服务的 Shell 命令");
