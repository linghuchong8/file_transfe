package com.transfer.psbcx.controller;
...
@Slf4j
public class TransferTransferRestController {
     ...
     */
    @RequestMapping("/list")
    public List<TransferDataShareMessage> queryMessages(@RequestParam Map<String, Object> condition) {
