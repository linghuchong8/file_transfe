...
@EnableScheduling
@Slf4j
public class TransferDownloadFileJob implements TransferJob {
    ...
    public TransferDownloadFileJob(TransferDataShareMessageMapper shareMsgMapper, TransferTransferRestActionService restActionService) {
    ...
    public synchronized void run() {
        List<TransferDataShareMessage> pending = shareMsgMapper.selectPendingDownload();
     ...
     */
    private void markDownloading(List<TransferDataShareMessage> pending) {
