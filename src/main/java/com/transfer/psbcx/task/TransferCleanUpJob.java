...
@EnableScheduling
@Slf4j
public class TransferCleanUpJob implements TransferJob {
    ...
    public synchronized void run() {
        ...
        int keepDays = Integer.parseInt(TransferAppPropertiesUtil.getProperty("delete.local.data.interval", "3"));
        String rootDir = TransferStringHelper.addEndSeparator(
                TransferAppPropertiesUtil.getProperty("data.share.download.dir.prefix"));
