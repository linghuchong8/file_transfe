 ...
 * @author yuanjihong
 */
public class TransferSftpTools implements AutoCloseable {

    private final transient Logger logger = LoggerFactory.getLogger(TransferSftpTools.class);
    ...
    public TransferSftpTools(final String username, final String password, final String host, final int port) {
    ...
    public TransferSftpTools(final String username, final String host, final int port, final String privateKey) {
        this.username = username;
        this.host = host;
        this.port = port;
    ...
    public void upload(final String basePath, final String directory,
        ...
        try {
            ...
            final String fullPath = TransferStringHelper.addEndSeparator(basePath) + directory;
    ...
    public void download(String directory, String saveDirectory) throws SftpException {
        ...
        String localSaveDir = TransferStringHelper.getPathByOS(saveDirectory);
