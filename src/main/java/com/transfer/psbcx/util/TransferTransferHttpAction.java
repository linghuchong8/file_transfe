 ...
 * @author xiehao
 */
public class TransferTransferHttpAction {

    private static final Logger log = LoggerFactory.getLogger(TransferTransferHttpAction.class);
    ...
    public TransferTransferHttpAction(String ipList) {
    ...
    public boolean downloadFile(JSONObject jsonInput, String backupPluginPath) {
        ...
        log.error("文件下载重试 {} 次仍失败", TransferTransferConstants.MAX_RETRIES);
        return false;
    }
    ...
    public boolean ackMessage(String messageAckId) {
        ...
        log.error("消息回执重试 {} 次仍失败", TransferTransferConstants.MAX_RETRIES);
        return false;
    }
